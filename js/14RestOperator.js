...
meses.splice(2, 1); // Elimina dentro del arreglo 
console.table(meses);  // Desventaja modifica todo el arreglo

// Rest Operator o Spread Operator para general un NUEVO ARRAY

const nuevoArreglo = [...meses, "Junio"];
console.log(nuevoArreglo); // No modifica el areglo original
